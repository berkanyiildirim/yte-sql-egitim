...
INSERT INTO public.films(title)
VALUES('Joker'),
      ('Avengers: Endgame'),
      ('Parasite');
...
INSERT INTO public.film_reviews(film_id, review)
VALUES(1, 'Excellent'),
      (1, 'Awesome'),
      (2, 'Cool'),
      (NULL, 'Beautiful');
...
-- UNION Demo
DROP TABLE IF EXISTS public.top_rated_films;
CREATE TABLE public.top_rated_films(
	title VARCHAR NOT NULL,
	release_year SMALLINT
);

DROP TABLE IF EXISTS public.most_popular_films;
CREATE TABLE public.most_popular_films(
	title VARCHAR NOT NULL,
	release_year SMALLINT
);
...
---
CREATE TABLE public.distinct_demo (
	id serial NOT NULL PRIMARY KEY,
	bcolor VARCHAR,
	fcolor VARCHAR
);

INSERT INTO public.distinct_demo (bcolor, fcolor)
VALUES
	('red', 'red'),
	('red', 'red'),
	('red', NULL),
